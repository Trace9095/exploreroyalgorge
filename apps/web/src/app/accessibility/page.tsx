          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="opacity-80">
                Explore Royal Gorge is committed to ensuring digital accessibility for people with disabilities.
            ...
            <section>
              ...
              <p className="opacity-80 mb-3">
                Explore Royal Gorge relies on the following technologies for conformance with WCAG 2.1:
              </p>
            ...
            <section>
              ...
              <p className="opacity-80">
                We welcome your feedback on the accessibility of Explore Royal Gorge. If you experience
            ...
            <section>
              ...
              <p className="opacity-80">
                Explore Royal Gorge assesses the accessibility of this website through self-evaluation
